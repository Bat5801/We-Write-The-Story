{
  ...
  "items": [
    ...
    { "id": "broken_bell", "name": "破碎的铜铃", "icon": "🔔", "description": "棺路上捡到的破碎铜铃，铃身上刻着'陆'字。" }
  ],
  "map": {
    "title": "青山县殡仪馆 & 旧水库 & 棺路",
    "locations": [
  ...
  "nodes": {
    "start": {
      ...
      "choices": [
        ...
        { "text": "查看客车编号（隐藏线索）", "next": "check_bus_number" }
      ]
    },
    "check_bus_number": {
      "id": "check_bus_number",
    ...
    "walk_to_coffin": {
      ...
      "choices": [
        { "text": "站在第13个位置", "next": "coffin_road_correct_hard" },
        { "text": "站在第12个位置", "next": "coffin_road_wrong_hard" },
        { "text": "站在第1个位置", "next": "coffin_road_wrong_hard" },
        { "text": "站在第7个位置", "next": "coffin_road_wrong_hard" }
      ]
    },
    "coffin_road_correct_hard": {
      ...
      "choices": [
        { "text": "把木牌放进棺材", "next": "put_tag" },
        { "text": "先回答他的问题", "next": "answer_question" }
      ]
    },
    ...
    "talk_to_seven": {
      ...
      "choices": [
        { "text": "让他回到棺材里", "next": "let_back" },
        { "text": "阻止他", "next": "stop_him" }
      ]
    },
    "let_back": {
      "id": "let_back",
