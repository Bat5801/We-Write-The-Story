{
  ...
  "items": [
    ...
    { "name": "黑玉戒", "id": "black_jade_ring", "icon": "💍", "description": "沈长河的黑玉戒，暗红纹路已蔓延至整个戒面。" },
    { "name": "镇棺铃", "id": "zhen_guang_ling", "icon": "🔔", "description": "沈家的镇棺铃，已经裂成两半，还能响最后一次。" },
  ...
  "nodes": {
    ...
    "pick_wooden_plate": {
      ...
      "choices": [
        ...
        { "text": "先回沈家告诉父亲", "next": "return_to_tell" }
      ]
    },
    "search_graveyard": {
      "id": "search_graveyard",
      "location": "graveyard",
      "text": "沈河川在乱坟岗搜寻了一圈。除了这座木牌，还有几块坍塌的墓碑，其中一块上刻着“送棺匠人张氏之墓”，日期模糊。\n\n他回到木牌前，捡起它，看到背面那行字。\n\n他沉默片刻，决定先把木牌带回沈家，再做打算。",
      "actions": [
        { "type": "addItem", "itemId": "wooden_plate" },
        { "type": "setVar", "name": "found_unnamed_shop", "value": true }
      ],
      "choices": [
        { "text": "回沈家与父亲商议", "next": "return_to_tell" },
    ...
    "go_to_hanging_coffin": {
      ...
      "text": "陈掌柜深深看了他一眼。“你确定？”\n\n“确定。”\n\n陈掌柜从柜台下取出一卷古卷。“这是去南岭深处的地图。那口倒悬黑棺在‘无主家’的内层，没有活人带路，你走不到。”\n\n“谁可以带路？”\n\n“送棺人。但送棺人不会为你带路，除非你答应他一件事。”\n\n“什么事？”\n\n“完成棺道未竟的使命——把南岭最后一处缺口封上。”\n\n沈河川接过古卷。“我答应。”\n\n陈掌柜看着他，目光复杂。“你会后悔的。”\n\n“也许。但我更怕什么都不做。”",
      "actions": [
