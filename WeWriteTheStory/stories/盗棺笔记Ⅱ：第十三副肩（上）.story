{
  ...
  "nodes": {
    ...
    "open_eighth": {
      ...
      "choices": [
        { "text": "输入071312", "next": "password_correct" },
        { "text": "输入071308", "next": "password_wrong_1" },
        { "text": "输入199807", "next": "password_wrong_2" },
        { "text": "输入120713", "next": "password_wrong_3" }
      ]
    },
    "password_correct": {
      "id": "password_correct",
