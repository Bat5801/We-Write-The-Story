{
  ...
  "items": [
    ...
    { "id": "coffin_token", "name": "棺债令牌", "icon": "🔑", "description": "刻着'三代抬棺'的令牌。" }
  ],
  "map": {
    "title": "无归坳·沈家老宅",
    "locations": [
      { "id": "no_return_ao", "name": "无归坳", "description": "南岭最深处，原棺所在之地。" },
      { "id": "original_coffin", "name": "原棺", "description": "天下所有棺的源头。" },
      { "id": "shen_home_modern", "name": "沈家老宅（现代）", "description": "沈河川住的地方。" },
      { "id": "basement", "name": "地下室", "description": "沈家老宅的地下室，藏着棺账。" },
      { "id": "study", "name": "书房", "description": "沈河川的书房，发现全家福的地方。" }
    ],
  ...
  "nodes": {
    ...
    "accept_fate": {
      ...
      "choices": [
        { "text": "继续替棺", "next": "continue_coffin" },
    ...
    "leave_ao": {
      ...
      "choices": [
        ...
        { "text": "离开地下室", "next": "leave_basement" }
      ]
    },
    "read_ledger_modern": {
