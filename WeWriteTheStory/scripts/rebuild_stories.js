...
const storyFiles = [
    { id: 'aotai_line', name: 'aotai_line.story' },
    ...
    { id: 'raven_eater', name: 'ravenEater.story' },
    ...
    { id: 'the_stolen_coffin_2_part1', name: '盗棺笔记Ⅱ：第十三副肩（上）.story' },
    { id: 'the_stolen_coffin_2_part1_5', name: '盗棺笔记Ⅱ：第十三副肩（中上）.story' },
    { id: 'the_stolen_coffin_2_part2', name: '盗棺笔记Ⅱ：第十三副肩（中）.story' },
    { id: 'the_stolen_coffin_2_part2_5', name: '盗棺笔记Ⅱ：第十三副肩（中下）.story' },
    { id: 'the_stolen_coffin_2_part3', name: '盗棺笔记Ⅱ：第十三副肩（下）.story' },
    { id: 'the_stolen_coffin_2_hard_part1', name: '盗棺笔记Ⅱ：第十三副肩（上）[Hard].story' },
    { id: 'the_stolen_coffin_2_hard_part1_5', name: '盗棺笔记Ⅱ：第十三副肩（中上）[Hard].story' },
    { id: 'the_stolen_coffin_2_hard_part2', name: '盗棺笔记Ⅱ：第十三副肩（中）[Hard].story' },
    { id: 'the_stolen_coffin_2_hard_part2_5', name: '盗棺笔记Ⅱ：第十三副肩（中下）[Hard].story' },
    { id: 'the_stolen_coffin_2_hard_part3', name: '盗棺笔记Ⅱ：第十三副肩（下）[Hard].story' }
];
...
const collections = [
    {
        ...
        stories: [
            ...
            { id: 'raven_eater', title: '烤鸭场：渡鸦的烹饪冒险' }
        ]
    },
    {
    ...
    },
    {
        ...
        stories: [
            ...
            { id: 'the_stolen_coffin_2_part1', title: '盗棺笔记Ⅱ：第十三副肩（上）' },
            { id: 'the_stolen_coffin_2_part1_5', title: '盗棺笔记Ⅱ：第十三副肩（中上）' },
            { id: 'the_stolen_coffin_2_part2', title: '盗棺笔记Ⅱ：第十三副肩（中）' },
            { id: 'the_stolen_coffin_2_part2_5', title: '盗棺笔记Ⅱ：第十三副肩（中下）' },
            { id: 'the_stolen_coffin_2_part3', title: '盗棺笔记Ⅱ：第十三副肩（下）' }
        ]
    },
    {
        ...
        stories: [
            ...
            { id: 'the_stolen_coffin_2_hard_part1', title: '盗棺笔记Ⅱ：第十三副肩（上）[Hard]' },
            { id: 'the_stolen_coffin_2_hard_part1_5', title: '盗棺笔记Ⅱ：第十三副肩（中上）[Hard]' },
            { id: 'the_stolen_coffin_2_hard_part2', title: '盗棺笔记Ⅱ：第十三副肩（中）[Hard]' },
            { id: 'the_stolen_coffin_2_hard_part2_5', title: '盗棺笔记Ⅱ：第十三副肩（中下）[Hard]' },
            { id: 'the_stolen_coffin_2_hard_part3', title: '盗棺笔记Ⅱ：第十三副肩（下）[Hard]' }
        ]
    }
];
