...
const storyFiles = [
    ...
    { id: 'hechuan_old_records_part1', name: '盗棺笔记：河川旧录（上）.story', locked: true },
    { id: 'hechuan_old_records_part2', name: '盗棺笔记：河川旧录（下）.story', locked: true },
    { id: 'the_stolen_coffin_hard', name: '盗棺笔记(Hard).story' },
    { id: 'hechuan_old_records_hard', name: '盗棺笔记：河川旧录(Hard).story', locked: true }
];
...
const collections = [
    ...
    },
    {
        ...
        stories: [
            ...
            { id: 'hechuan_old_records_part1', title: '🔒 河川旧录（上）', locked: true },
            { id: 'hechuan_old_records_part2', title: '🔒 河川旧录（下）', locked: true }
        ]
    },
    {
        ...
        stories: [
            ...
            { id: 'hechuan_old_records_hard', title: '🔒 河川旧录(Hard)', locked: true }
        ]
    }
];
