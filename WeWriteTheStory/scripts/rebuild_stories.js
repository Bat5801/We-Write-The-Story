...
const storyFiles = [
    ...
    { id: 'hechuan_old_records', name: '盗棺笔记：河川旧录.story' },
    { id: 'hechuan_old_records_part1', name: '盗棺笔记：河川旧录（上）.story' },
    { id: 'hechuan_old_records_part2', name: '盗棺笔记：河川旧录（下）.story' },
    { id: 'the_stolen_coffin_hard', name: '盗棺笔记(Hard).story' },
    { id: 'hechuan_old_records_hard', name: '盗棺笔记：河川旧录(Hard).story' }
];
...
const collections = [
    ...
    },
    {
        ...
        stories: [
            ...
            { id: 'hechuan_old_records_part2', title: '河川旧录（下）' }
        ]
    },
    {
        ...
        stories: [
            ...
            { id: 'hechuan_old_records_hard', title: '河川旧录(Hard)' }
        ]
    }
];
